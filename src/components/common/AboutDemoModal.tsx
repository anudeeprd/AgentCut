...
export const AboutDemoModal: React.FC<AboutDemoModalProps> = ({ isOpen, onClose }) => {
  ...
  const sampleVideoPrompts = [
    ...
    'Animate NEW YORK so it fades in large in the center and moves to the top.',
    'Slowly zoom toward the skyline from 2 to 7 seconds.',
    'Fade Explore More in and out.',
